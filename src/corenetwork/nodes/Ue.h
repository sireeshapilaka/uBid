...
public:
    ...
    // For each scheduled rpi need, this is 1: if round1 returned no feasible RPIs,
    // 2: if utility did not exceed threshold, 3: if bid was lost or , 4: if bid was won
    // 5: there wasnt enough money to place a bid
